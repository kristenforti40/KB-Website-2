...
const InquiryPage: React.FC = () => {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        const subject = encodeURIComponent(`Training Inquiry from ${formState.name}`);
        const body = encodeURIComponent(
`You have a new training inquiry from the Keri Brion Racing website.
        ...
        <div>
            <div className="bg-gradient-to-b from-brand-teal/70 to-brand-teal/60 backdrop-blur-sm py-10 shadow-md">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-center text-white drop-shadow-lg">Training Inquiry</h1>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
                    <div className="bg-white p-8 rounded-lg shadow-lg border border-stone-200">
                        <p className="text-center text-stone-600 mb-8 text-lg">
                            Interested in joining our program? Please fill out the form below with details about your horse, and we will get back to you as soon as possible.
                        </p>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6">
                                <label htmlFor="message" className="block text-sm font-medium text-stone-600 mb-1">Message <span className="text-xs text-stone-500">(Please include horse's name, age, sex, and any relevant history)</span></label>
